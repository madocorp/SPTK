...
class SDL {
  ...
  const SDL_EVENT_WINDOW_DISPLAY_CHANGED = 0x213;

  const SDL_EVENT_DISPLAY_ORIENTATION = 0x151;
  const SDL_EVENT_DISPLAY_ADDED = 0x152;
  const SDL_EVENT_DISPLAY_REMOVED = 0x153;
  const SDL_EVENT_DISPLAY_MOVED = 0x154;
