...
class TableRow extends Element {
  ...
  public function setTablePosition(int $row, int $lineHeight, int $offsetY = 0, int $minWidth = 0): void {
    $this->dataRow = $row;
  ...
  protected function measure(): void {
    ...
    $this->geometry->width = max($this->minWidth, array_sum(array_map(fn($cell) => $cell->getCellWidth(), $this->descendants)));
